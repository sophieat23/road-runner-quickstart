...
public class BackupCopy extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        waitForStart();
           ...
           if (opModeIsActive()) {
            ...
            // //lift (that doesnt work)
            //  if(gamepad1.left_bumper) {
            //         lift.setMode(DcMotorEx.RunMode.RUN_USING_ENCODER);
            //         // DR4BMotor = - gamepad1.left_trigger*500;
            //         lift.setVelocity(600);
            //         // telemetry.addData("Outake Speed", lift.getVelocity());
            //         h = lift.getCurrentPosition();
                    
                    
            //     } else if(gamepad1.right_bumper){
            //         lift.setMode(DcMotorEx.RunMode.RUN_USING_ENCODER);
            //         // DR4BMotor = gamepad1.right_trigger*1000;
