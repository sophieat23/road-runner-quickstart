...
public class DriveConstants {
    ...
    public static PIDFCoefficients MOTOR_VELO_PID = new PIDFCoefficients(25, 0, 10,15.65);
     ...
     * empirically tuned.
     */
    public static double kV = 1.0 / rpmToVelocity(MAX_RPM); //0.016195745489133502
